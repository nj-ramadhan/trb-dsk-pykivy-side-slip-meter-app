...
class ScreenMain(MDScreen):   
    ...
    def on_antrian_row_press(self, instance):
        global dt_no_antrian, dt_no_pol, dt_no_uji, dt_nama, dt_side_slip_flag
    ...
    def regular_update_display(self, dt):
        ...
        global count_starting, count_get_data
        global dt_user, dt_no_antrian, dt_no_pol, dt_no_uji, dt_nama, dt_jenis_kendaraan, dt_side_slip_flag
        ...
        try:
            ...
            screen_sideslip_meter.ids.lb_no_antrian.text = str(dt_no_antrian)
            screen_sideslip_meter.ids.lb_no_pol.text = str(dt_no_pol)
            screen_sideslip_meter.ids.lb_no_uji.text = str(dt_no_uji)
            screen_sideslip_meter.ids.lb_nama.text = str(dt_nama)
            screen_sideslip_meter.ids.lb_jenis_kendaraan.text = str(dt_jenis_kendaraan)
            ...
            if(count_starting <= 0):
                ...
                if(flag_play):
                    ...
                    screen_sideslip_meter.ids.lb_side_slip.text = str(count_starting)
            ...
            screen_sideslip_meter.ids.lb_operator.text = f'Login Sebagai: {dt_user}' if dt_user != '' else 'Silahkan Login'
    ...
    def exec_reload_table(self):
        ...
        try:
            ...
            tb_antrian.execute(f"SELECT noantrian, nopol, nouji, sideslip_flag, user, merk, type, idjeniskendaraan, jbb, bahan_bakar, warna FROM {TB_DATA}")
    ...
    def exec_start(self):
        global dt_side_slip_flag, dt_no_antrian, dt_user
        global flag_play
